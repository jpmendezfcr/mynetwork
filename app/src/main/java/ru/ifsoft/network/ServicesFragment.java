...
public class ServicesFragment extends Fragment implements Constants {
    ...
    CardView mGoogleCard, mFacebookCard, mLoginCreateCard;
    Button mFacebookDisconnectBtn, mGoogleDisconnectBtn, mLoginCreateBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mLoginCreateCard = rootView.findViewById(R.id.login_create_card);
        ...
        mLoginCreateBtn = (Button) rootView.findViewById(R.id.login_create_button);
        ...
        mLoginCreateBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void updateView() {
        ...
        mLoginCreateCard.setVisibility(View.GONE);
        ...
        if (App.getInstance().getAccountFree() != 0) {
            ...
            mLoginCreateCard.setVisibility(View.VISIBLE);
    ...
    public void googleOauth(String action) {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_ACCOUNT_OAUTH, null,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("oauth_name", "");
                params.put("oauth_email", "");
    ...
    public void disconnectFromFacebook() {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_ACCOUNT_OAUTH, null,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("uid", oauth_id);
                params.put("oauth_type", Integer.toString(OAUTH_TYPE_FACEBOOK));
                params.put("oauth_name", "");
                params.put("oauth_email", "");
                            ...
                            if (response.has("error")) {
                                ...
                                if (!response.getBoolean("error")) {
                                    ...
                                    if (response.has("error_code")) {
                                        ...
                                        if (response.getInt("error_code") == ERROR_OAUTH_ID_TAKEN) {
